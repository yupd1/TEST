...
public class JsonUtil {
	public static final String timeFormatPattern = "dd-MM-yyyy HH:mm";
	 ...
	 */
	public static String json2KeyValue(JSONObject json, String key) throws JSONException{
		if(json.isNull(key))
			return null;
		else
	 ...
	 * @throws JSONException 
	 */
	public static JSONObject json2KeyObj(JSONObject json, String key) throws JSONException{
		if(json.isNull(key))
			return null;
		else
	 ...
	 * @throws JSONException 
	 */
	public static JSONArray json2KeyArr(JSONObject json, String key) throws JSONException{
		if(json.isNull(key))
			return null;
		else
	...
	public static JSONArray str2JsonArr(String jsonStr) {
		...
		try {
			JSONObject dataJson = new JSONObject("{data:"+jsonStr+"}");
			return dataJson.getJSONArray("data");
